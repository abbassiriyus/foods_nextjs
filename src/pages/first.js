...
<div className={s.anastasiya}>
    ...
    <div className={s.povar}>
        <div className={s.povar1}>
            ...
            <p>Кондитеры могут приготовить десерты с индивидуальным дизайном и начинкой - оформите заказ на
                понравившийся десерт и уточните пожелания в чате.
                Забрать заказ можно самостоятельно или оформить доставку. </p>
        </div>
        <div className={s.povar2}>
            <p>Cкачай мобильное приложение&nbsp;<strong>Повар на <br/> связи</strong></p>
    ...
    <div className={s.footer}>
        ...
        <div className={s.foot2}>
            <a style={{fontSize: '25px'}} href="#">support@povarnasvyazi.ru</a><br/>
            <a href="#">Условия использования сервиса и информация о компании</a>
        </div>
    </div>
