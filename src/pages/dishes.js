...
<input placeholder='Время приготовления' defaultValue={oneFood.preparation_time}  id='preparation_time' className={s.inputlar_1} type="number" /><br />
...
<input placeholder='Цена, р'  defaultValue={oneFood.price}   id='price' className={s.inputlar_1} type="number" /><br />
